...
* **🖥 System Information**
  ...
  * 🖴 [<mark style="color:green;">Mounts</mark>](#user-content-fn-19)[^19]
  * ⌛ [<mark style="color:orange;">Idle time</mark>](#user-content-fn-20)[^20]
* **📡 Network & Devices**
  * 📶 [<mark style="color:blue;">Network Speed</mark>](#user-content-fn-21)[^21]
  * 🌐 [<mark style="color:blue;">Interfaces</mark>](#user-content-fn-22)[^22]
  * 📱 [<mark style="color:blue;">Bluetooth</mark>](#user-content-fn-23)[^23]
  * 🛜 [<mark style="color:blue;">WiFi</mark>](#user-content-fn-24)[^24]
  * 🔌 [<mark style="color:blue;">Wake-on-LAN (WOL)</mark>](#user-content-fn-25)[^25]
* 🎚️ **Audio/Video**
  * 🎤 [<mark style="color:blue;">Microphone Used</mark>](#user-content-fn-26)[^26]
  * 🎥 [<mark style="color:blue;">Camera Used</mark>](#user-content-fn-27)[^27]
  * 📷 [<mark style="color:blue;">Webcam Show</mark>](#user-content-fn-28)[^28]
  * 🎶 [<mark style="color:orange;">Media</mark>](#user-content-fn-29)[^29]
  * 🔆 [<mark style="color:orange;">Brightness</mark>](#user-content-fn-30)[^30]
  * 💡 [<mark style="color:orange;">Screen On/Off</mark>](#user-content-fn-31)[^31]
  * &#x20;⛶ [<mark style="color:orange;">Fullscreen</mark>](#user-content-fn-32)[^32]
  * 📸 [<mark style="color:orange;">Screenshot Show</mark>](#user-content-fn-33)[^33]
  * 🎧 [<mark style="color:orange;">Audio Select</mark>](#user-content-fn-34)[^34]
* 🧮 **Input/Output**
  * 🎮 [<mark style="color:blue;">Gamepad Used</mark>](#user-content-fn-35)[^35]
  * ⌨️ [<mark style="color:orange;">Keyboard Hotkeys</mark>](#user-content-fn-36)[^36]
  * 🖱️ [<mark style="color:orange;">Mouse control</mark>](#user-content-fn-37)[^37]
  * 🔑 [<mark style="color:orange;">Send Keys</mark>](#user-content-fn-38)[^38]
* **🧰 Applications & Tools**
  * 🌍 [<mark style="color:blue;">LNXlink Update</mark>](#user-content-fn-39)[^39]
  * 🗣️ [<mark style="color:blue;">Speech Recognition</mark>](#user-content-fn-40)[^40]
  * 🧲 [<mark style="color:green;">GPIO</mark>](#user-content-fn-41)[^41]
  * 📺 [<mark style="color:green;">IR Remote</mark>](#user-content-fn-42)[^42]
  * 🎮 [<mark style="color:orange;">Steam</mark>](#user-content-fn-43)[^43]
* 🧩 **Advanced/Other**
  * ⏳ [<mark style="color:blue;">Inference Time</mark>](#user-content-fn-44)[^44]
  * 📜 [<mark style="color:blue;">Logging Level</mark>](#user-content-fn-45)[^45]
  * 🐚 [<mark style="color:green;">Bash commands</mark>](#user-content-fn-46)[^46]
  * 🐳 [<mark style="color:green;">Docker</mark>](#user-content-fn-47)[^47]
  * 📊 [<mark style="color:green;">Statistics</mark>](#user-content-fn-48)[^48]
  * 📮 [<mark style="color:green;">RESTful</mark>](#user-content-fn-49)[^49]
  * 🪟 [<mark style="color:orange;">Display Environment</mark>](#user-content-fn-50)[^50]
* **📦 Custom modules**
...
[^19]: ## &#x20;Mounts Usage
    ...
    Creates a sensor for showing the percentage of used space on each mounted volume.

    [Usage](modules-settings.md#mounts-usage)
...
[^29]: ## &#x20;Media
    ...
    [Media Setup/Usage](media-player.md)
